...
/**
 * TrendAura Pricing Page - V2 Optimized
 * متوافق تماماً مع محرك الصلاحيات الجديد
 */
export default function Pricing() {
  ...
  // نستخدم المقارنة القياسية الموحدة (lowercase + trim)
  ...
  return (
    <div className={`w-full max-w-6xl mx-auto select-none dir-rtl text-right animate-fade-in pb-12 transition-colors duration-300 ${
      ...
      <div className="flex justify-start mb-6">
        <button
          ...
          className={`px-4 py-2 rounded-xl text-[10px] font-black flex items-center gap-2 transition-all active:scale-95 border ${
            theme === 'dark'
              ? 'bg-[#160f30]/40 border-[#1f1438] text-cyan-400 hover:bg-white/5'
      ...
      {/* شبكة الكروت: تمرير البيانات بشكل نظيف للـ PricingCard */}
      ...
      <div className={`mt-12 p-6 border rounded-3xl text-center max-w-2xl mx-auto transition-colors duration-300 ${
        ...
        <h4 className="text-xs font-black mb-1">🛡️ ضمان أمان المدفوعات</h4>
        <p className="text-[10px] font-bold text-slate-400 leading-relaxed">
          جميع المعاملات مشفرة ومؤمنة بالكامل عبر بوابات دفع ميسر المعتمدة.
        </p>
      </div>
    </div>
  )
