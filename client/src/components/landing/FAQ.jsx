  ...
  const qaPairs = [
    {
      ...
      a: 'المنصة  تعتمد على خوارزميات ذكاء اصطناعي مدربة على تحليل السلوك الجماهيري المليوني. تقوم بصياغة مقدمات (Hooks) خاطفة ومثيرة للاهتمام تمنع المشاهد من التمرير في أول 3 ثوانٍ، وهو العامل الأساسي الذي يجعل خوارزميات مواقع التواصل الاجتماعي تدفع بمقطعك لصفحة الـ Explore.'
    },
    {
