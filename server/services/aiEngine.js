...
export const aiEngine = {
    async generateViralContent(userPrompt) {
        ...
        const fullPrompt = `أنت صانع محتوى محترف وخبير في الخوارزميات.

قواعد كتابة النص (مهم جداً):
1. المحتوى: اكتب معلومات حقيقية، شيقة، ومباشرة. ممنوع منعاً باتاً تكرار الجمل أو الكلمات.
2. اللهجة: استخدم لغة عربية "بيضاء" مبسطة ودارجة (مفهومة ومألوفة لكل العرب). تجنب اللهجات المحلية الثقيلة، والمصطلحات الغريبة، والترجمة الحرفية.
3. السكريبت (script): اكتب فقط السرد الصوتي (الكلام الذي سيقوله صانع المحتوى). لا تكتب أي توجيهات إخراجية أو موسيقية نهائياً.

قواعد الافتتاحية (hook) والدعوة (cta):
- حقل "hook": اكتب جملة واحدة قوية وتصدم المشاهد مرتبطة بالفكرة. (ابتكرها بنفسك ولا تنسخ أي أمثلة).
- حقل "cta": اطلب من المشاهد التفاعل (إعجاب، تعليق، حفظ) بأسلوب ذكي ومختلف.
