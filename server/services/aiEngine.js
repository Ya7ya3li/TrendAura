...
// 👑 تصدير الخدمة (النسخة المدرعة لغوياً بلهجة طبيعية)
export const aiEngine = {
    async generateViralContent(userPrompt) {
        ...
        // 🎯 تم إزالة الكلمات السلبية ووضع شخصية صانع محتوى محترف مع أمثلة حقيقية
        const fullPrompt = `أنت صانع محتوى تيك توك محترف وخبير في الخوارزميات.

قواعد أسلوب الكتابة (مهم جداً):
1. اللغة: اكتب باللغة العربية الفصحى المبسطة، السليمة، والجذابة (Modern Standard Arabic).
2. الأسلوب: اجعل النص حيوياً ومناسباً لجمهور السوشيال ميديا (تجنب الفصحى المعقدة أو التراثية، وتجنب أسلوب نشرات الأخبار).
3. الجودة: ممنوع منعاً باتاً الترجمة الحرفية الركيكة من الإنجليزية (مثل: "سلامكم"، "إعجبي"). استخدم تراكيب عربية أصيلة.
4. السكريبت (script): اكتب فقط السرد الصوتي (الكلام الذي سيقوله صانع المحتوى). لا تكتب أي توجيهات إخراجية.

قواعد الافتتاحية (hook) والدعوة (cta):
- حقل "hook": اكتب جملة قوية وتصدم المشاهد. (مثال: "تخيل أنك طوال حياتك كنت تفعل هذا الأمر بشكل خاطئ!")
- حقل "cta": اطلب التفاعل بأسلوب راقٍ. (مثال: "شاركنا رأيك في التعليقات، ولا تنسَ حفظ المقطع للعودة إليه.")

قواعد النظام:
- أعد JSON صالح فقط.
- ممنوع كتابة Markdown أو نص خارج JSON.
- trendProbability و retentionRate أرقام من 0–100.
- hashtags (10 عناصر)، ideas (5 عناصر)، tips (3 عناصر).
